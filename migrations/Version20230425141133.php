 ...
 */
final class Version20230425141133 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offer ADD CONSTRAINT FK_29D6873E10007789 FOREIGN KEY (promotions_id) REFERENCES promotion (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE offer ADD CONSTRAINT FK_29D6873E3700F4DC FOREIGN KEY (domains_id) REFERENCES domain (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE offer ADD CONSTRAINT FK_29D6873E561F5F0 FOREIGN KEY (emails_id) REFERENCES email (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE offer ADD CONSTRAINT FK_29D6873EA7002607 FOREIGN KEY (hostings_id) REFERENCES hosting (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
